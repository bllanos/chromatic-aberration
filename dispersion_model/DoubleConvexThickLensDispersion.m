...
stats_reference = repmat(stats_real(:, ior_lens_reference_index), 1, n_wavelengths);
polyfun_real = xylambdaPolyfit(...
    stats_reference, dispersion_fieldname, max_degree_xy, disparity_raw_real, dispersion_fieldname,...
...
if plot_polynomial_model
    plotXYLambdaPolyfit(...
        stats_reference, dispersion_fieldname, disparity_raw_real, dispersion_fieldname,...
