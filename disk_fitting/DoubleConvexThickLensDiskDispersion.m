...
polyfun_disks = xylambdaPolyfit(...
    centers_reference, dispersion_fieldname, max_degree_xy, disparity_raw_disks, dispersion_fieldname,...
...
if plot_polynomial_model
    plotXYLambdaPolyfit(...
        centers_reference, dispersion_fieldname, disparity_raw_disks, dispersion_fieldname,...
        lens_params.wavelengths, lens_params.wavelengths(ior_lens_reference_index), n_lambda_plot, polyfun_disks...
    );
end