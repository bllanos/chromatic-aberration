...
%   'maximum_weights' identical, unless `sampling_options.progression` has a
%   value of `'last'`, as it will fix the regularization weights for all
%   spectral resolutions to the same values. Instead, `reg_options` can be given
%   an additional field:
