...
% Colour space conversion data
color_map_filename = '/home/llanos/Downloads/NikonD5100ColorMapData.mat';
...
multi_step = ~channel_mode && solvePatchesMultiADMMOptions.sampling_options.show_steps;
...
if ~isempty(target_patch)
    if channel_mode
        ...
        solvePatchesMultiADMMOptions.patch_options.target_patch = target_patch;
    end
    if run_entire_image
        ...
        for pad = 0:length(paddings)
            if run_entire_image && ps == 0 && pad == 0
                if channel_mode
                    ...
                    solvePatchesMultiADMMOptions.patch_options.patch_size = image_sampling;
                    solvePatchesMultiADMMOptions.patch_options.padding = 0;
                end
            ...
            elseif ps > 0 && pad > 0
                if channel_mode
                    ...
                    solvePatchesMultiADMMOptions.patch_options.patch_size = patch_sizes(ps, :);
                    solvePatchesMultiADMMOptions.patch_options.padding = paddings(pad);
                end
