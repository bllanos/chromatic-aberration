...
if has_spectral
    ...
    spectral_names = cell(n_images, 1);
    for i = 1:n_images
        [~, spectral_names{i}] = fileparts(spectral_filenames{i});
    end
...
if has_rgb
    ...
    if has_spectral
        ...
        for i = 1:n_images
            if ~strcmp(rgb_names{i}, spectral_names{i})
...
if has_raw
    ...
    if has_spectral
        if (n_images_spectral ~= n_images_raw)
            error('Mismatched number of spectral and RAW images.');
        end
        for i = 1:n_images
            if ~strcmp(raw_names{i}, spectral_names{i})
                error('Not all spectral image filenames and RAW image filenames match.');
            end
        end
    end
    if has_rgb
        if (n_images_rgb ~= n_images_raw)
            error('Mismatched number of colour and RAW images.');
        end
        for i = 1:n_images
            if ~strcmp(rgb_names{i}, raw_names{i})
                error('Not all colour image filenames and RAW image filenames match.');
            end
        end
    end
...
for i = 1:n_images
    ...
    if has_spectral
        I_spectral_gt = loadImage(spectral_names{i}, dp.spectral_images_variable);
        if has_dispersion_spectral
    ...
    if has_rgb
        I_rgb_gt = loadImage(rgb_names{i}, dp.rgb_images_variable);
        if has_dispersion_rgb
    ...
    if has_raw
        I_raw_gt = loadImage(raw_names{i}, dp.raw_images_variable);
        I_raw_gt = im2double(I_raw_gt);
    ...
    for w = 1:n_weights
        if has_color_map
            ...
            name_params = [raw_names{i}, sprintf(...
                '_bands%d_L1L1_patch%dx%d_pad%d_weights%gAnd%g_',...
            ...
            [...
                ...
                image_sampling, I_raw_gt, bayer_pattern, df_spectral_reverse,...
            ...
            name_params = [raw_names{i}, sprintf(...
                '_bands%d_L1L1NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
                n_bands, patch_size(1), patch_size(2), padding,...
                weights(w, 1), weights(w, 2)...
                )];
            [...
            ...
            baek2017Algorithm2Options.nonneg = true;
            name_params = [raw_names{i}, sprintf(...
                '_bands%d_L1L2NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
                n_bands, patch_size(1), patch_size(2), padding,...
                weights(w, 1), weights(w, 2)...
                )];
            [...
            ...
            baek2017Algorithm2Options.nonneg = true;
            name_params = [raw_names{i}, sprintf(...
                '_bands%d_L2L1NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
                n_bands, patch_size(1), patch_size(2), padding,...
                weights(w, 1), weights(w, 2)...
                )];
            [...
            ...
            baek2017Algorithm2Options.nonneg = true;
            name_params = [raw_names{i}, sprintf(...
                '_bands%d_L2L2NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
                n_bands, patch_size(1), patch_size(2), padding,...
                weights(w, 1), weights(w, 2)...
                )];
            [...
        ...
        baek2017Algorithm2Options.nonneg = false;
        name_params = [raw_names{i}, sprintf(...
            '_RGB_L1L1_patch%dx%d_pad%d_weights%gAnd%g_',...
            patch_size(1), patch_size(2), padding,...
            weights(w, 1), weights(w, 2)...
            )];
        I_rgb = solvePatches(...
            image_sampling, I_raw_gt, bayer_pattern, df_rgb_reverse,...
            sensor_map_rgb,...
        ...
        baek2017Algorithm2Options.nonneg = true;
        name_params = [raw_names{i}, sprintf(...
            '_RGB_L1L1NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
            patch_size(1), patch_size(2), padding,...
            weights(w, 1), weights(w, 2)...
            )];
        I_rgb = solvePatches(...
        ...
        baek2017Algorithm2Options.nonneg = true;
        name_params = [raw_names{i}, sprintf(...
            '_RGB_L1L2NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
            patch_size(1), patch_size(2), padding,...
            weights(w, 1), weights(w, 2)...
            )];
        I_rgb = solvePatches(...
        ...
        baek2017Algorithm2Options.nonneg = true;
        name_params = [raw_names{i}, sprintf(...
            '_RGB_L2L1NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
            patch_size(1), patch_size(2), padding,...
            weights(w, 1), weights(w, 2)...
            )];
        I_rgb = solvePatches(...
        ...
        baek2017Algorithm2Options.nonneg = true;
        name_params = [raw_names{i}, sprintf(...
            '_RGB_L2L2NonNeg_patch%dx%d_pad%d_weights%gAnd%g_',...
            patch_size(1), patch_size(2), padding,...
            weights(w, 1), weights(w, 2)...
            )];
        I_rgb = solvePatches(...
    ...
    I_rgb_warped = demosaic_ARI(rgb, pattern);
    saveImages(...
        output_directory, raw_names{i},...
