...
admm_algorithms.spectralL2L2L1 = struct(...
    'name', 'Spectral L2L2L1',...
    'file', 'L2L2L1',...
    'enabled', false,...
    'spectral', true,...
    'priors', [false, false, true],...
    'options', struct('norms', [false, false, true], 'nonneg', false)...
);
admm_algorithms.spectralL2L2L2 = struct(...
    'name', 'Spectral L2L2L2',...
    'file', 'L2L2L2',...
    'enabled', true,...
    'spectral', true,...
    'priors', [false, false, true],...
...
admm_algorithms.colorL2L2L1 = struct(...
    'name', 'Color L2L2L1',...
    'file', 'L2L2L1',...
    'enabled', false,...
    'spectral', false,...
...
admm_algorithms.colorL2L2L2 = struct(...
    'name', 'Color L2L2L2',...
    'file', 'L2L2L2',...
    'enabled', true,...
    'spectral', false,...
...
for i = 1:n_images
    ...
    for w = 1:n_weights
        for f = 1:length(admm_algorithm_fields)
            ...
            options_f = fieldnames(algorithm.options);
            for f_options = 1:length(options_f)
                baek2017Algorithm2Options.(options_f{f_options}) =...
                    algorithm.options.(options_f{f_options});
            end
