...
% - 'color_weights_gt': Similar to 'color_weights', but for converting
%   pixels in the true images to colour.
...
sampling_options_gt = solvePatchesMultiADMMOptions.sampling_options;
sampling_options_gt.power_threshold = 1;
sampling_options_gt.n_bands = 0;
sampling_options_gt.interpolant = @triangle;
[...
    color_weights_gt, ~, bands_spectral...
] = samplingWeights(...
  sensor_map, bands_color, {}, sampling_options_gt, samplingWeightsVerbose...
);

[...
    color_weights, spectral_weights, bands...
] = samplingWeights(...
  sensor_map, bands_color, bands_spectral, solvePatchesMultiADMMOptions.sampling_options, samplingWeightsVerbose...
);
...
for d = 1:n_dispersion
    ...
    I_rgb_gt = imageFormation(I_spectral_gt, color_weights_gt, imageFormationOptions);
    I_rgb_warped_gt = imageFormation(I_warped_gt, color_weights_gt, imageFormationOptions);
                    ...
                    for i = 1:n_i_vector
                        ...
                        if has_dispersion
                            dispersion_matrix_patch = dispersionfunToMatrix(...
                                dispersionfun, bands_spectral, image_sampling_f, image_sampling_f,...
