...
%     chromatic aberration in images" (Guanajuato). 6th Pacific-Rim
%     Symposium on Image and Video Technology, PSIVT 2013. Springer Verlag.
...
if n_eval_patches_x > 0 && n_eval_patches_y > 0
    ...
    dataset_params.evaluation.custom_spectral.gt.radiance = [...
...
% spectral roughness
dataset_params.evaluation.custom_spectral.gt.scanlines = [
...
for d = 1:n_dispersion
    ...
    for no = 1:n_noise_fractions
        ...
        dataset_params.evaluation.custom_spectral.(name_params_table_gt) = dataset_params.evaluation.custom_spectral.gt;
        ...
        name_params_table_gt = sprintf(...
            'Dispersion%g_noise%g', dispersion_px_d, noise_fraction...
        );
        dataset_params.evaluation.custom_spectral.(name_params_table_gt) = dataset_params.evaluation.custom_spectral.gt;
        saveImages(...
            output_directory, name_params_gt,...
            ...
            for pp = 1:n_padding
                ...
                if solvePatchesSpectralOptions.sampling_options.show_steps
                    ...
                    for f = 1:n_criteria
                        ...
                        true_image_name = [name_params_table_gt, '_', criteria_filenames{f}, 'multiStep'];
                        dataset_params.evaluation.custom_spectral.(true_image_name) = dataset_params.evaluation.custom_spectral.gt;
                        evaluateAndSaveSpectral(...
                            output_directory, dataset_params, true_image_name, step_name_params_tables, fg_spectral_step...
                        );
