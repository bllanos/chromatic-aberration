...
elseif strcmp(name, 'kaist-crop')
    ...
    dataset_params.params_patches = struct(...
        'scene04', [576, 1736; 2231, 1400],...
        'scene10', [587, 992; 1998, 614],...
        'scene21', [304, 1457; 1583, 1080],...
        'scene26', [182, 1241; 2174, 708]...
    );
    dataset_params.evaluation = struct(...
        ...
        'custom_spectral', struct(...
            'scene04', struct(... %'reference_patch', [350, 1737, 101, 101],...
                'radiance', [
                    1937, 704, 15, 15;
                    2764, 456, 15, 15;
                    1979, 155, 15, 15;
            ...
            'scene10', struct(... %'reference_patch', [234, 976, 101, 101],...
            ...
            'scene21', struct(... %'reference_patch', [669, 330, 101, 101],...
                'radiance', [
            ...
            'scene26', struct(... %'reference_patch', [339, 629, 101, 101],...
                'radiance', [
