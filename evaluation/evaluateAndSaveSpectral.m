...
if save_multi_comparisons
    ...
    if isfield(fg_spectral, 'radiance')
        ...
        if isfield(options, 'reference_patch')
            ...
            savefig(...
                fg_spectral.radiance(n_patches + 1),...
                [...
                    I_filename,...
                    sprintf(...
                        '_referencePatch_X%dY%dW%dH%d.fig',...
                        options.reference_patch(1),...
                        options.reference_patch(2),...
                        options.reference_patch(3),...
                        options.reference_patch(4)...
                    )...
                ], 'compact'...
            );
            close(fg_spectral.radiance(n_patches + 1))
        end
        for i = 1:n_patches
