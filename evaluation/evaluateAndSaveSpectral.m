...
if ~short_call
    ...
    if isfield(fg_spectral_current, 'error_map')
        ...
        savefig(...
            fg_spectral_current.error_map(1),...
            [name_params sprintf('_diffBand%d.fig', max_ind)], 'compact'...
        );
        close(fg_spectral_current.error_map(1));
        savefig(...
            fg_spectral_current.error_map(2),...
            [name_params '_mapRMSE.fig'], 'compact'...
        );
        close(fg_spectral_current.error_map(2));
        savefig(...
            fg_spectral_current.error_map(3),...
            [name_params '_mapGOF.fig'], 'compact'...
        );
        close(fg_spectral_current.error_map(3));
    end
