...
admm_algorithms.spectralL1Lap1NonNeg = struct(...
    'name', 'Spectral L1Lap1NonNeg',...
    'file', 'L1Lap1NonNeg',...
    'enabled', true,...
    'spectral', true,...
...
admm_algorithms.spectralL1Lap2NonNeg = struct(...
    'name', 'Spectral L1Lap2NonNeg',...
    'file', 'L1Lap2NonNeg',...
    'enabled', true,...
    'spectral', true,...
    'priors', [true, false, true],...
...
admm_algorithms.colorL1Lap1NonNeg = struct(...
    'name', 'Color L1Lap1NonNeg',...
    'file', 'L1Lap1NonNeg',...
    'enabled', true,...
    'spectral', false,...
    'priors', [true, false, true],...
...
admm_algorithms.colorL1Lap2NonNeg = struct(...
    'name', 'Color L1Lap2NonNeg',...
    'file', 'L1Lap2NonNeg',...
    'enabled', true,...
    'spectral', false,...
    'priors', [true, false, true],...
...
admm_algorithms.colorL1Lap1 = struct(...
    'name', 'Color L1Lap1NonNeg',...
    'file', 'L1Lap1NonNeg',...
    'enabled', true,...
    'spectral', false,...
...
admm_algorithms.colorL1Lap2 = struct(...
    'name', 'Color L1Lap2NonNeg',...
    'file', 'L1Lap2NonNeg',...
    'enabled', true,...
    'spectral', false,...
