...
rgb_correction_algorithms.sun2017 = struct(...
    ...
    'file', 'cct',...
    'enabled', true,...
    'psf_sz', 0.06,... % PSF estimation window size, as a fraction of the image's largest dimension
    'win_sz', 7,... % CCT implementation window size, as an absolute number of pixels
    'alpha', 0.3,...
    'beta', 0.3,...
    'iter', 3 ...
);