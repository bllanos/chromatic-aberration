...
if resample_images
    ...
    if (desired_bands_spectral(2) - desired_bands_spectral(1)) > (bands_spectral(2) - bands_spectral(1))
        ...
        spectral_weights_output = resampleArrays(...
            desired_bands_spectral, eye(length(desired_bands_spectral)), bands_spectral,...
            'spline', 0 ...
        );
...
[...
  ...
  sensor_map, bands_color, bands_radiance, samplingWeightsOptions...
);
