...
incident_position = [ 0, 0, U ];
    ...
    function stats = psfStatistics(X_object)
        ...
        stats.mean_position = principal_point_prime + (X_image_rays .* magnification_correction);
        stats.max_position = stats.mean_position;
