function [ imageFn, U, U_prime, P ] = opticsFromLens( n0, n1, n2, r1, r2, d_lens )
% OPTICSFROMLENS  Obtain imaging quantities from lens geometry
%
% ## Syntax
% imageFn = opticsFromLens( n0, n1, n2, r1, r2, d_lens )
% [ imageFn, U ] = opticsFromLens( n0, n1, n2, r1, r2, d_lens )
% [ imageFn, U, U_prime ] = opticsFromLens( n0, n1, n2, r1, r2, d_lens )
% [ imageFn, U, U_prime, P ] = opticsFromLens( n0, n1, n2, r1, r2, d_lens )
%
% ## Description
% imageFn = opticsFromLens( n0, n1, n2, r1, r2, d_lens )
...
%   A function of a single argument, `X_object`, which is a 3-element
%   vector containing the x, y, and z-coordinates of an object point. The
%   object point is assumed to be located at higher z-coordinates than the
%   front surface of the lens.
%
%   `imageFn` returns a 3-element row vector containing the x, y, and
%   z-coordinates of the image point formed by the lens, corresponding to
%   the object point `X_object`.
%
...
%     which covers the thick lens, and section 4.4.1, which covers
%     refraction at a single surface of revolution.
...
% Equations 12 and 14 in section 4.4.1
