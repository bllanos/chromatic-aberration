...
[ ...
    image_position, ray_power, incident_position, incident_position_cartesian ...
] = doubleSphericalLens( ray_params, verbose_ray_tracing );

%% Form rays into an image

I = densifyRays(...
    incident_position, incident_position_cartesian, image_position,...
    ray_power, verbose_image_formation ...
);